{****************************************************************
  $Id: udPreferences.pas,v 1.1 2006-03-07 05:35:48 dale Exp $
****************************************************************}
unit udPreferences;
...
uses Main, CommCtrl, EdTS, Menus, udKeyBinding, ConsVarsTypes;
  ...
  procedure TdPreferences.FormCreate(Sender: TObject);
  var i: Integer;
  begin
  ...
  procedure TdPreferences.FormDestroy(Sender: TObject);
  begin
    FKeys.Free;
  end;
